...
The two main groups of isosurface polygonization alrogithms are the primal, e.g. \cite{marching_cubes,transvoxel}, and dual, e.g. \cite{surface_nets,dual_contouring}, contouring algorithms.
