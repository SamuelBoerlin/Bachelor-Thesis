...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean QueryMenu
        {
            get
            {
                return SteamVR_Actions.default_QueryMenu;
            }
        }
        
        public virtual SteamVR_Action_Boolean PickMaterial
        {
            get
            {
                return SteamVR_Actions.default_PickMaterial;
            }
        }
        ...
        public virtual SteamVR_Action_Boolean CustomBrushEditingMenu
        {
            get
            {
                return SteamVR_Actions.default_CustomBrushEditingMenu;
            }
        }
        ...
        public virtual SteamVR_Action_Vector2 ScaleBrush
        {
            get
            {
                return SteamVR_Actions.default_ScaleBrush;
            }
        }
        
        public virtual SteamVR_Action_Boolean ToggleHints
        {
            get
            {
                return SteamVR_Actions.default_ToggleHints;
            }
        }
